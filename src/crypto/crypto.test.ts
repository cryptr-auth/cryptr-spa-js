...
describe('Crypto', () => {
  it('random() returns a safety random of 43 length chars', () => {
    expect(Crypto.random().length).toEqual(43)
  })
  ...
  it('randomB64UrlEncoded() returns a safety random of 43 length chars', () => {
    expect(Crypto.randomB64UrlEncoded().length).toEqual(43)
  })
